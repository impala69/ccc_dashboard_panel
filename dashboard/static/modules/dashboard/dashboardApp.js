...
myApp.config(function ($stateProvider, $authProvider) {
    ...
    var dashboard = {
        name: 'dashboard',
        url: '/dashboard',
        templateUrl: '/ccc_dashboard_panel/dashboard/static/modules/dashboard/views/dashboard.html'
    };

    var vps_list = {
        name: 'dashboard.vps_list',
        url: '/vps_list',
        templateUrl: '/ccc_dashboard_panel/dashboard/static/modules/dashboard/views/vps_list.html'
    };

    var overview = {
        name: 'dashboard.overview',
        url: '/overview',
        templateUrl: '/ccc_dashboard_panel/dashboard/static/modules/dashboard/views/overview.html'
    };

    var key_pairs = {
        name: 'dashboard.key_pairs',
        url: '/key_pairs',
        templateUrl: '/ccc_dashboard_panel/dashboard/static/modules/dashboard/views/key_pairs.html'
    };

    var volumes = {
        name: 'dashboard.volumes',
        url: '/volumes',
        templateUrl: '/ccc_dashboard_panel/dashboard/static/modules/dashboard/views/volumes.html'
    };

    var privacy = {
        name: 'dashboard.privacy',
        url: '/privacy',
        templateUrl: '/ccc_dashboard_panel/dashboard/static/modules/dashboard/views/privacy.html'
    };
